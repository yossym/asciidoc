...
.CodeBackColors
4 0 7 7 6 4 4 4 0 0 0 0 0 0 0 0

.CodeForeColors
7 0 5 4 1 9 11 1 0 0 0 0 0 0 0 0
...
Debug.Print isSheet(ActiveWorkbook, "まとめ")

Function isSheet(Wb As Workbook, Name As String) As Boolean
    Dim v As Variant
...
----
    ActiveSheet.Hyperlinks.Add _
            Anchor:=Range("A3"), Address:="Sheet2!A3"
----
...
== https://docs.microsoft.com/ja-jp/office/vba/language/reference/user-interface-help/keywords-by-task[タスク別のキーワード | Microsoft Docs]
